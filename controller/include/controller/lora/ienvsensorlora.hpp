/**
* @file     ienvsensor.hpp
* @brief    Interface for environment controller logic with LoRa.
...
#ifndef _PINICONTROLLER_IENVSENSORLORA_H_
#define _PINICONTROLLER_IENVSENSORLORA_H_
...
class IEnvSensorLora : public IEnvSensor {
    public:
        virtual ~IEnvSensorLora() = default;
...
#endif // _PINICONTROLLER_IENVSENSORLORA_H_